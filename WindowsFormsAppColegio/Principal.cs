...
namespace WindowsFormsAppColegio
{
    public partial class Principal : Form
    {
        ...
        private void Principal_Load(object sender, EventArgs e)
        {
            ...
            lblusuario.Text = FrmSesion.usuario_nombre;
            if (FrmSesion.id_tipo == "T0001")  //Admin
            {
            ...
            if (FrmSesion.id_tipo == "T0002") //Asistente
                {
            ...
            if (FrmSesion.id_tipo == "T0003") //Secretaria
            {
                usuariosToolStripMenuItem.Enabled = false;
                alumnosToolStripMenuItem.Enabled = true;
                salonesToolStripMenuItem.Enabled = true;
        ...
        private void linkCambiarClave_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
