...
namespace WindowsFormsAppColegio
{
    public partial class PassCambiar : Form
    {
        ...
        private void btnentrar_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                if (MessageBox.Show("¿Deseas cambiar tu contraseña?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Information) ==
        ...
        {
            label1.Text = FrmSesion.usuario_nick;
            label2.Text = FrmSesion.usuario_codigo;
        }
